//
//  VW_find_VW_GRI_high_resolution_cable.h
...
#ifndef VW_find_VW_GRI_high_resolution_cable_h
#define VW_find_VW_GRI_high_resolution_cable_h
...
void VW_find_VW_GRI_high_resolution_cable(){
#ifdef use_omp
    ...
    for (int jj = 0; jj < 2; jj++) {  //Looping over the BCL values for which the VW will be checked.
        ...
        for (t_S2 = t_S2_start; t_S2 < 1000.0; t_S2 = t_S2 + 0.05) {
            flag_retro_prop1 = 0;
...
#endif /* VW_find_VW_GRI_high_resolution_cable_h */

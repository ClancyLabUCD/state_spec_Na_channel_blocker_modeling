...
//
//  Created by Steffen Docken on 9/18/17.
...
#ifndef VW_find_VW_cable_h
#define VW_find_VW_cable_h
...
void VW_find_VW_cable(){
    ...
    for (int jj = 0; jj < 3; jj++) {  //Looping over the BCL values for which the VW will be checked.
        ...
        for(Bind_Scheme = 0; Bind_Scheme < 5; Bind_Scheme++){ //looping over the various Binding Schemes
            ...
            //chdir ("../1D_modified_Ten_Tusscher_with_drug_output/VW_results_12_22_17/"); //for my laptop (changes the directory to where results will be saved.)
            ...
            for (t_S2 = 290.0; t_S2 < 420.0; t_S2 = t_S2 + 0.5) {
                flag_retro_prop1 = 0;
